package com.tsyh.springbootdataelasticsearch;

import com.tsyh.springbootdataelasticsearch.bo.ProductConditionBO;
...
public class ProductRepository04Test {
    ...
    public void test() {
       ...
       condition.getCategories().forEach(category ->System.out.println(category.getName()));
    }
