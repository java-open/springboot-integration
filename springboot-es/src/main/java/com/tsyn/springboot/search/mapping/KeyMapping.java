package com.tsyn.springboot.search.mapping;


import com.tsyn.springboot.SpringbootEsApplication;
...
import com.tsyn.springboot.search.annotation.DefinitionQueryRepeatable;
...
public class KeyMapping {
    ...
    // 启动类所在包
    private static final String BOOTSTRAP_PATH = SpringbootEsApplication.class.getPackage().getName();
